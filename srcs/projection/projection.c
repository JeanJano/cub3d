...
/*   Updated: 2023/04/12 15:49:54 by jsauvage         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	dda_return = get_vector_distance(cub->player_x, cub->player_y,
	...
	if ((int)draw->wall_height % 2 == 1)
		draw->wall_height++;
	draw_ceil(i, &draw->y_pixel_draw,
		((WINDOW_HEIGHT - (int)(draw->wall_height)) / 2), cub);
