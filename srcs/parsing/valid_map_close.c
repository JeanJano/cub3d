...
/*   Updated: 2023/02/20 18:04:06 by jsauvage         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (i < parsing->map_height - 1 && i > 0 && j < parsing->map_width[i - 1] && parsing->map[i - 1][j] == 0)
		return (FALSE);
	if (i < parsing->map_height - 1 && j < parsing->map_width[i + 1] && parsing->map[i + 1][j] == 0)
		return (FALSE);
